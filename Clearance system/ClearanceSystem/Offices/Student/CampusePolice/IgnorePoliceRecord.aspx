<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="IgnorePoliceRecord.aspx.cs" Inherits="ClearanceSystem.Offices.Student.CampusePolice.IgnorePoliceRecord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sideNav" runat="server">
    <div id='cssmenu' style="margin-top: 25px;">
        <ul>
            <li class=''><a href="Police%20Home.aspx"><span>Home</span></a></li>
            <li class=''><a href="CampusePolice.aspx"><span>Record Case</span></a></li>
