...
<asp:Content ID="Content2" ContentPlaceHolderID="sideNav" runat="server">
    <div id='cssmenu' style="margin-top: 25px;">
        <ul>
            <li class=''><a href="Student%20Cafe%20Home.aspx"><span>Home</span></a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <form id="form1" runat="server">
      ...
      <div class="container" style="margin: 0px; padding: 0px; width: 100%;border:5px solid green;color: steelblue; background-color: #202030; border-radius: 25px;">
