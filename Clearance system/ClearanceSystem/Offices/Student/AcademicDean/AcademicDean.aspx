<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="AcademicDean.aspx.cs" Inherits="ClearanceSystem.Offices.Employee.AcademicDean.AcademicDean" %>
    ...
    <form id="form1" runat="server">
        <div class="container" style="margin: 0px; padding: 0px; width: 100%; color: steelblue; background-color: #202030; border-radius: 25px;">
            ...
            <div class="panel-group" id="accordion" >
                <div class="">
                    <div class="panel-heading" style="margin: 0px;  border-top-left-radius: 25px; border-top-right-radius: 25px; background-color: rgb(32, 32, 48); height:auto;">
                        ...
                        <table>
                            <tr class="success">
                                ...
                                <th colspan="2" style="color: rgba(243, 225, 225, 1);" class="auto-style7">Student ID :</th>
                        ...
                        <div class="panel-body" style="background-color: #E7E9EA; height:auto;" >
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 213px;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2"><%-- <li class=''><a href="AcademicDean.aspx"><span>Academic Dean</span></a></li>--%>
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2">
                                        <asp:Button ID="submit" runat="server" Text="Submit" CssClass="btn btn-success" Width="137px" Height="33px" OnClick="submit_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
