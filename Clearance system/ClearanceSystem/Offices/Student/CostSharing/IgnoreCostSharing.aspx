<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="IgnoreCostSharing.aspx.cs" Inherits="ClearanceSystem.Offices.Student.CostSharing.IgnoreCostSharing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sideNav" runat="server">
      <div id='cssmenu' style="margin-top: 25px;">         
        <ul>  
            <li class=''><a href="CostSharing.aspx"><span>Record Case</span></a></li> 
                    ...
                    <div id="collapse" class="<%Response.Write(state); %>">
                        <div class="panel-body" style="background-color: #E7E9EA ; height:auto;" >
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 213px;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style1" colspan="2" style="color: #FF0000">
                                        &nbsp;</th>
                                </tr>
                                <tr class="" style="background-color: #E7E9EA;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style5">
                                        <asp:Button ID="ClearAll" runat="server" Text="&gt;&gt;&gt;Clear &lt;&lt;&lt;" CssClass="btn  btn-danger" Width="219px" Height="35px" OnClick="ClearAll_Click" />
                                    </th>
                                    <td class="auto-style2">
                                        &nbsp;</td>
                                </tr>
