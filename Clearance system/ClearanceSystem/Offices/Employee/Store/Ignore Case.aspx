<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="Ignore Case.aspx.cs" Inherits="ClearanceSystem.Offices.Employee.Store.Ignore_Case" %>
            ...
            <div class="panel-group" id="accordion">
                <div class="">
                    ...
                    <div id="collapse" class="<%Response.Write(state); %>">
                        <div class="panel-body" style="background-color: #E7E9EA; width: 735px;">
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 348px;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style5">
                                        &nbsp;</th>
                                    <td class="auto-style2">
                                        <asp:Button ID="Clear" runat="server" Text="Clear Changed" CssClass="btn btn-info" Width="187px" Height="35px" OnClick="Clear_Click" />
                                    </td>
                                </tr>
                                <tr class="" style="background-color: #E7E9EA;">
