<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ClearanceSystem.HRM.Register" %>
                            ...
                            <div>
                                <table>
                                    <tr class="success">
                                        ...
                                        <td>
                                            <asp:Button ID="RegisterExcel" runat="server" Text="Register" CssClass="btn btn-info" Height="32px" Width="126px" OnClick="RegisterExcel_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                             
                                <asp:GridView ID="GridView1" AllowPaging="true" AutoGenerateColumns="false" runat="server" Width="100%" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="436px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="TextBox4" runat="server" Text='<%#Eval( "AcademicR") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TextBox5" runat="server" Text='<%#Eval( "Salary") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TextBox8" runat="server" Text='<%#Eval( "Departement") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
