<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="Ignore Case.aspx.cs" Inherits="ClearanceSystem.Offices.Student.Proctor.Ignore_Case" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
 ...
 <div class="container" style="margin: 0px; padding: 0px; width: 100%; color: steelblue; background-color: #202030; border-radius: 25px;">
    ...
    <div class="panel-group" id="accordion">
                <div class="">
                  <div class="panel-heading" style="margin: 0px; border-top-left-radius: 25px; border-top-right-radius: 25px; background-color: rgb(32, 32, 48);">    <table>
                            <tr class="success">
                                <th colspan="2" style="color: rgba(243, 225, 225, 1);" class="auto-style5">
                                    <asp:TextBox ID="StudID" placeholder="Student Id" runat="server" CssClass="form-control" Width="273px" Height="31px"></asp:TextBox>
                                </th>
                        ...
                        <div class="panel-body" style="background-color: #E7E9EA;">
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 213px;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2">
                                        <asp:CheckBoxList ID="CheckBoxBookList" runat="server" Height="18px" Width="178px">
                                        </asp:CheckBoxList>
                                    </td>
                                </tr>
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2">
                                        <asp:Button ID="Rcive" runat="server" Text="Clear selected" CssClass="btn btn-info" Width="191px" Height="42px" OnClick="Rcive_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
