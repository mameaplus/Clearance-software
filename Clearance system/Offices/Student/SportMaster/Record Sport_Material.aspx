<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="Record Sport_Material.aspx.cs" Inherits="ClearanceSystem.Offices.Student.SportMaster.Record_Sport_Material" %>
                    ...
                    <div id="Div1" class="<%Response.Write(State2); %>">
                        <div class="panel-body" style="background-color: #E7E9EA; height: 415px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
                            ...
                            <div class="alert-warning">
                                <asp:GridView ID="GridView1" AllowPaging="true" AutoGenerateColumns="false" runat="server" Width="651px" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="15">
                                    <Columns>
