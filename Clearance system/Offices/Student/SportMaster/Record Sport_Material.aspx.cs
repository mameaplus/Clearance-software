...
namespace ClearanceSystem.Offices.Student.SportMaster
{
    public partial class Record_Sport_Material : System.Web.UI.Page
    {
        ...
        protected void Register_Click(object sender, EventArgs e)
        {
            ...
            string fileLocation = Server.MapPath("~/Excel/Sport Material.xlsx");
            ...
            di.sqlCmdTxt = "insert into StudSportMaterial(Name,Quantity,Date)values(";
            di.str1 = "StudSportMaterial";
