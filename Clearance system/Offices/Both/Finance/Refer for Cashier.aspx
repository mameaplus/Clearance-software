<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="Refer for Cashier.aspx.cs" Inherits="ClearanceSystem.Offices.Both.Finance.Refer_for_Cashier" %>
                    ...
                    <div id="collapse" class="<%Response.Write(state); %>">
                        <div class="panel-body" style="background-color: #E7E9EA; height: 420px;">
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 213px;">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style1">Postion</th>
                                    <td class="auto-style2">
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2">
                                        <asp:TextBox ID="Credit" runat="server" CssClass="form-control" Height="31px" Width="262px"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    ...
                                    <td class="auto-style2">
                                        <asp:Button ID="Give" runat="server" Text="Go To Cashier " CssClass="btn btn-info" Width="145px" Height="37px" OnClick="submit_Click" />
                                    </td>
                                </tr>
                            </table>
