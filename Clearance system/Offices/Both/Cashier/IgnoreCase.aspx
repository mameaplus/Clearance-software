<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="IgnoreCase.aspx.cs" Inherits="ClearanceSystem.Offices.Both.Cashier.IgnoreCase" %>
            ...
            <div class="panel-group" id="accordion">
                <div class="">
                    <div class="panel-heading" style="margin: 0px; border-top-left-radius: 25px; border-top-right-radius: 25px; background-color: rgb(32, 32, 48);">
                        <table>
                            <tr class="success">
                                <th style="color: rgba(243, 225, 225, 1);">Employee  ID :</th>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="wEmp" runat="server"></asp:Label></td>
                            </tr>
                        </table>
                    </div>
                    <div id="collapse" class="<%Response.Write(state); %>" style="height: auto;">
                        <div class="panel-body" style="background-color: #E7E9EA; height: auto;">
                            <table class="table" style="border-radius: 20px 20px 20px 20px; height: 213px;">
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="HideId" runat="server" Value='<%#Eval("FId") %>' Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style1" colspan="2" style="padding: 12px">
                                        <asp:GridView ID="GridView2" runat="server" CellPadding="4" Width="460px" ForeColor="#333333" GridLines="None" Height="82px">
                                            <AlternatingRowStyle BackColor="White" />
                                ...
                                <tr class="" style="background-color: #E7E9EA;">
                                    <th class="auto-style5">
                                        <asp:Button ID="ClearAll" runat="server" Text="Clear All" CssClass="btn  btn-danger" Width="146px" Height="35px" OnClick="ClearAll_Click1" />
                                    </th>
                                    <td class="auto-style2">
