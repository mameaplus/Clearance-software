...
namespace ClearanceSystem.Offices.Both.Book_Store
{
    public partial class Record_Case : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            Session["0"] = "on";
            Book book = new Book();
            Return rtnBook = book.FindBook(bookID.Text, "bookstore");
            ...
            if (rtnBook.Bool)
            {
                ...
                else
                {
                  ...
                  ViewState["phone"] =  Dep = (string)rtnStudent.ds.Tables[0].Rows[0][6]; 

                    Session["rdm"] = new Class().sendEmail("", "");
                    DataItem sms = new DataItem();
                    sms.str1 = ViewState["phone"] as string;
                    sms.str2 = "From Sport master Agreement code :" + Session["rdm"] as string;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox3.Text == (string)Session["rdm"])
            {
                ...
                if (new Record().RecordForClear(DI, "Bookstore"))
                {
