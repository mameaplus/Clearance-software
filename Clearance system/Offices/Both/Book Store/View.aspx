<%@ Page Title="" Language="C#" MasterPageFile="~/frontPageOffice.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="ClearanceSystem.Offices.Both.Book_Store.View" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <form id="Form1" di="form1" runat="server">
        ...
        <div class="container" style="margin: 0px; padding: 0px; width: 100%; color: steelblue;">
            ...
            <FooterStyle BackColor="#4A3C8C" ForeColor="#4A3C8C" />
            <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#F7F7F7"/>
            <PagerStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Right" />
            <RowStyle BackColor="#4A3C8C" ForeColor="#4A3C8C" />
            <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
            <SortedAscendingCellStyle BackColor="#F4F4FD" />
            <SortedAscendingHeaderStyle BackColor="#4A3C8C" />
